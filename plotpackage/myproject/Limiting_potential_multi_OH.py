# -*- coding: utf-8 -*-
"""
Created on Thu Aug 19 13:17:16 2021
...
for types in ['top-new', 'line', 'triangle', 'paral-new', 'island-new', 'overly-new']:
    ...
    # plt.axline(( ECO_d[0], ECO_d[0]/m-b/m), slope=1/m, color='black')

    plt.title(text[index], fontsize=14)
    if index==3 or index==4 or index==5:
        plt.xlabel(r'$E_{\mathrm{OH}}$ (eV)', fontsize=14)
